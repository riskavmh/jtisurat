...
<body>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="assets/form/vendor/global/global.min.js"></script>
    <script src="assets/form/js/quixnav-init.js"></script>
    <script src="assets/form/js/custom.min.js"></script>

    <!-- Jquery Validation -->
    <script src="assets/form/vendor/jquery-validation/jquery.validate.min.js"></script>
    <!-- Form validate init -->
    <script src="assets/form/js/plugins-init/jquery.validate-init.js"></script>
