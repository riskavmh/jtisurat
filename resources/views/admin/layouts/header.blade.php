        ...
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown nxl-h-item">
                ...
                <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                    ...
                    <div class="notifications-item">
                        <img src="{{ asset('assets/dashboard/images/avatar/2.png') }}" alt="" class="rounded me-3 border">
                    ...
                    <div class="notifications-item">
                        <img src="{{ asset('assets/dashboard/images/avatar/3.png') }}" alt="" class="rounded me-3 border">
                        <div class="notifications-desc">
                    ...
                    <div class="notifications-item">
                        <img src="{{ asset('assets/dashboard/images/avatar/4.png') }}" alt="" class="rounded me-3 border">
                        <div class="notifications-desc">
            ...
            <div class="dropdown nxl-h-item">
                <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                    <img src="{{ asset('assets/dashboard/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar me-0">
                </a>
                <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                    <div class="dropdown-header">
                        <div class="d-flex align-items-center">
                            <img src="{{ asset('assets/dashboard/images/avatar/1.png') }}" alt="user-image" class="img-fluid user-avtar">
                            <div>
